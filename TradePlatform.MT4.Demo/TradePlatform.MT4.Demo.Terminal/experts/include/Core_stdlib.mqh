...
string ErrorDescription(int error_code)
{
	...
	case 140: error_string="buy positions only allowed";                               break;
	...
	case 4110: error_string="buys are not allowed in the expert properties";           break;
	case 4111: error_string="sells are not allowed in the expert properties";          break;
