...
string Bridge_NET_MQL(string message[])
{
	string result = "###NORESULT###";
	
	if(result == "###NORESULT###")
	{
		result = Bridge_NET_MQL_Custom(message);
	}
	
	if(result == "###NORESULT###")
	{
		result = Bridge_NET_MQL_Variables(message);
	}
	
	if(result == "###NORESULT###")
	{
		result = Bridge_NET_MQL_Info(message);
	}
	
	if(result == "###NORESULT###")
	{
		result = Bridge_NET_MQL_Common(message);
	}

	if(result == "###NORESULT###")
	{
		result = Bridge_NET_MQL_Trading(message);
	}	
	
	if(result == "###NORESULT###")
	{
		result = Bridge_NET_MQL_WindowFunctions(message);
	}

	if(result == "###NORESULT###")
	{
		result = Bridge_NET_MQL_TechIndicators(message);
	}
	
	if(result == "###NORESULT###")
	{
		result = Bridge_NET_MQL_Checkup(message);
	}
	
	return (result);
}

string Bridge_NET_MQL_Variables(string message[])
{
	if(message[1] == "Ask")
	return(Ask);
...
string Bridge_NET_MQL_Common(string message[])
{
	if(message[1] == "Alert")
	{
		Alert(message[2]);
...
string Bridge_NET_MQL_Info(string message[])
{
...
string Bridge_NET_MQL_Trading(string message[])
{
...
string Bridge_NET_MQL_WindowFunctions(string message[])
{ 
...
string Bridge_NET_MQL_TechIndicators(string message[])
{
	if(message[1] == "iAC")
...
string Bridge_NET_MQL_Checkup(string message[])
{
	...
	if(message[1] == "IsDllsAllowed")
	return(IsDllsAllowed());
	
	if(message[1] == "IsExpertEnabled")
	return(IsExpertEnabled());
	
	if(message[1] == "IsLibrariesAllowed")
	return(IsLibrariesAllowed());
	
	if(message[1] == "IsOptimization")
	return(IsOptimization());
	
	if(message[1] == "IsStopped")
	return(IsStopped());
	
	if(message[1] == "IsTesting")
	return(IsTesting());
	
	if(message[1] == "IsTradeAllowed")
	return(IsTradeAllowed());
	
	if(message[1] == "IsTradeContextBusy")
	return(IsTradeContextBusy());
	
	if(message[1] == "IsVisualMode")
	return(IsVisualMode());
	
	if(message[1] == "UninitializeReason")
